...
void main() {
    ...
    // Ideally we convolve SH with Specular Lobe, but cheap way is sampling along R.
    // We can blur the lookup based on roughness if we had MIPs of coeffs?
    // For now, just sample along R.
    ...
    // It works okay for rough surfaces. For shiny, it will look blurry (which is SH limitation).
